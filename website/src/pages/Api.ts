...
export function Api(): ReturnType<typeof createElement> {
  useHead({
    ...
    description: 'JavaScript API reference for Steamroller. rollup(), watch(), defineConfig(), parseAst(), and more.',
    canonical: 'https://steamroller.asymmetric-effort.com/#/api',
  });

  return createElement('div', null,
    createElement('h1', null, 'API Reference'),
    createElement('p', { className: 'page-subtitle' }, 'Steamroller exports the same API as rollup for drop-in compatibility.'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('table', { className: 'table' },
        ...
        createElement('tbody', null,
          createElement('tr', null,
            createElement('td', null, createElement('code', null, 'steamroller')),
            createElement('td', null, 'rollup, watch, defineConfig, VERSION'),
          ),
          createElement('tr', null,
            createElement('td', null, createElement('code', null, 'steamroller/parseAst')),
            createElement('td', null, 'parseAst, parseAstAsync'),
          ),
          createElement('tr', null,
            createElement('td', null, createElement('code', null, 'steamroller/loadConfigFile')),
            createElement('td', null, 'loadConfigFile'),
          ),
          createElement('tr', null,
            createElement('td', null, createElement('code', null, 'steamroller/getLogFilter')),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('p', null, 'The main bundling function. Returns a RollupBuild object.'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('p', null, 'Standalone JavaScript parser producing ESTree-compatible ASTs.'),
      createElement('pre', null,
        createElement('code', null,
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('p', null, 'Steamroller is a drop-in replacement. Migration requires minimal changes:'),
      createElement('pre', null,
        createElement('code', null,
          '// Before\n' +
      ...
      createElement('p', null, 'All @rollup/plugin-* packages work without modification.'),
    ),
  );
}
