...
export function Features(): ReturnType<typeof createElement> {
  useHead({
    ...
    description: 'Full feature list for Steamroller: tree-shaking, code splitting, 6 output formats, 27-hook plugin system, source maps, watch mode.',
    canonical: 'https://steamroller.asymmetric-effort.com/#/features',
  });

  return createElement('div', null,
    createElement('h1', null, 'Features'),
    createElement('p', { className: 'page-subtitle' }, 'Everything rollup does, steamroller does \u2014 with zero dependencies.'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('table', { className: 'table' },
        ...
        createElement('tbody', null,
          ...
          formatRow('umd', '\u2014', 'Universal Module Definition (CJS + AMD + global)'),
          formatRow('amd', '\u2014', 'Asynchronous Module Definition (RequireJS)'),
          formatRow('iife', '\u2014', 'Immediately Invoked Function Expression'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('ul', { className: 'feature-list' },
        li('Statement-level tree-shaking with multi-pass dead code elimination'),
        ...
        li('Full source map support (separate, inline, hidden) with composition'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('p', null, 'Steamroller performs statement-level tree-shaking with configurable side-effect detection:'),
      createElement('ul', { className: 'feature-list' },
        li('Multi-pass iterative algorithm that converges to minimal output'),
        li('Three presets: recommended (default), smallest, safest'),
        li('Pure annotations: /*@__PURE__*/, /*#__PURE__*/, /*@__NO_SIDE_EFFECTS__*/'),
    ...
    createElement('section', { className: 'section' },
      ...
      createElement('p', null, '27 hooks across build, output, and watch phases:'),
      createElement('table', { className: 'table' },
        createElement('thead', null,
          createElement('tr', null,
        ...
        createElement('tbody', null,
          createElement('tr', null,
            ...
            createElement('td', null, 'options, buildStart, resolveId, resolveDynamicImport, load, shouldTransformCachedModule, transform, moduleParsed, buildEnd'),
          ),
          createElement('tr', null,
            createElement('td', null, 'Output'),
            createElement('td', null, 'outputOptions, renderStart, renderDynamicImport, resolveFileUrl, resolveImportMeta, banner, footer, intro, outro, renderChunk, augmentChunkHash, generateBundle, writeBundle, renderError, closeBundle'),
          ),
          createElement('tr', null,
...
function formatRow(format: string, aliases: string, description: string): ReturnType<typeof createElement> {
