import { createElement, Router, Route, Fragment } from '@asymmetric-effort/specifyjs';
...
export function App(): ReturnType<typeof createElement> {
  return createElement(Fragment, null,
    ...
    createElement('main', { className: 'main', role: 'main' },
      createElement(Router, null,
        createElement(Route, { path: '/', component: Home, exact: true }),
        createElement(Route, { path: '/features', component: Features, exact: true }),
