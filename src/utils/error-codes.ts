...
export const EXTERNAL_SYNTHETIC_EXPORTS = "EXTERNAL_SYNTHETIC_EXPORTS" as const;
...
export const ILLEGAL_IDENTIFIER_AS_NAME = "ILLEGAL_IDENTIFIER_AS_NAME" as const;
...
export const MISSING_IMPLICIT_DEPENDANT = "MISSING_IMPLICIT_DEPENDANT" as const;
